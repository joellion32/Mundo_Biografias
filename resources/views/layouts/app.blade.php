...
<head>
    ...
    <!--Metas Descripcion-->
  <meta name="description" content="Biografas y Historias">
  <meta name="keywords" content="Biografias,Dominicanas,Historias,Tareas">
  <meta name="author" content="two Developers">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                            <a class="nav-link" href="{{ route('login') }}"><i class="fas fa-user"></i> {{ __('Iniciar') }}</a>
                            </li>
                        @else
