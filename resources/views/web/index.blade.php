...
<nav class="navbar navbar-expand-lg navbar-dark indigo mb-4">
  ...
  <!--/.Navbar-->
      ...
      <section id="biografias">
        ...
        <h2 class="my-5 h3 text-center">Biografias</h2>
@if(count($entrada))
        <!--First row-->
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            ...
            <div class="card">
              ...
              <div class="view overlay">
                <img src="{{$entradas->file}}" class="card-img-top" alt="">
                <a href="/vista{{$entradas->slug}}">
              ...
              <div class="card-body text-center">
                <!--Category & Title-->
                <a href="/vista{{$entradas->slug}}" style="color:black;">
                  <h5>{{$entradas->name}}</h5>
                </a>
